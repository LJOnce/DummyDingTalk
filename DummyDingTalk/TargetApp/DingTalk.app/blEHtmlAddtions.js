...
if (typeof HTMLElement != 'undefined') {
    ...
    HTMLElement.prototype.BL_TITLE_ATTR_NAME = "bltitle";
    ...
    HTMLElement.prototype.setTitle = function(title) {
        this.setAttribute(this.BL_TITLE_ATTR_NAME, title);
    }

    HTMLElement.prototype.getTitle = function() {
        this.getAttribute(this.BL_TITLE_ATTR_NAME);
    }
    ...
    HTMLElement.prototype.hasTapElementWithTagName = function(tagName) {
    ...
    HTMLElement.prototype.LONG_PRESS_TIME = 500;
    ...
    HTMLElement.prototype.tapStartHandler = function(event) {
        ...
        if(BLEditor && event.target.hasTapElementWithClass(BLEditor.CONST.BL_INSERT_AUDIO_CLASSNAME)) {
    ...
    HTMLElement.prototype.addLongPressUpEventListener = function(callback, capture) {
        if (typeof callback != 'function') {
            return;
        }
    ...
    HTMLElement.prototype.offset = function() {
        var rect = new Rect(this.offsetLeft , this.offsetTop , 0 , 0);
        var parentNode = this.offsetParent; 

        while(parentNode) { 
            rect.top  += parseInt(parentNode.offsetTop,10); 
            rect.left += parseInt(parentNode.offsetLeft,10); 
            parentNode = parseInt(parentNode.offsetParent,10); 
        } 

        rect.right  = rect.left + parseInt(this.offsetWidth,10);
        rect.bottom = rect.top  + parseInt(this.offsetHeight,10);
