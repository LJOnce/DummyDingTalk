...
BLEditor.Debug = {
    ...
    log : function(str) {
        ...
        // BLEditor.NativeNotifier.notify('ioslog' , {
        //     str : str
        // });
    ...
    showCursor : function() {
        ...
        paddedDiv.addClass('bl-debug');
        paddedDiv.addClass('bl-debug-padded');
        paddedDiv.hide();

        var visibleDiv = document.createElement('div');
        visibleDiv.addClass('bl-debug');
        visibleDiv.addClass('bl-debug-visible');
        visibleDiv.hide();

        var paddedInfoDiv = document.createElement('div');
        paddedInfoDiv.addClass('bl-debug');
        paddedInfoDiv.addClass('bl-debug-paddedinfo');
        paddedInfoDiv.hide();

        var visibleInfoDiv = document.createElement('div');
        visibleInfoDiv.addClass('bl-debug');
        visibleInfoDiv.addClass('bl-debug-visibleinfo');
        visibleInfoDiv.hide();
